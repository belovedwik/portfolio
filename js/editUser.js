...
$(document).ready(function(){
	...
	var validator = editUserForm.validate({
		...
		rules:{
			...
			email : { required : true, email : true, 
                     remote : 
                         { url : baseURL + "adminator/users/checkEmailExists", 
                          type :"post", 
	...
	var validator = editProfileForm.validate({
		...
		rules:{
			fname :{ required : true },
			mobile : { required : true, digits : true },
			email : { required : true, email : true, remote : { url : baseURL + "adminator/users/checkEmailExists", type :"post", data : { userId : function(){ return $("#userId").val(); } } } },
		},
		messages:{
			fname :{ required : "This field is required" },
			mobile : { required : "This field is required", digits : "Please enter numbers only" },
