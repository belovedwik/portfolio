            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?= base_url() . adminPath ?>/users/editUser" method="post" id="editUser" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        <label for="fname">Full Name</label>
                                        <input type="text" class="form-control" id="fname" placeholder="Full Name" name="fname" value="<?= $name; ?>" maxlength="128">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="role" name="role">
                                            ...
                                            if(!empty($roles))
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option value="<?= $rl->roleId; ?>" <?php if($rl->roleId == $roleId) {echo "selected=selected";} ?>>
                                                        <?= $rl->role ?></option>
                                                    <?php
                                                }
                                            }
...
<script src="<?= base_url(); ?>js/editUser.js" type="text/javascript"></script>